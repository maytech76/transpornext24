...
(function(c) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-buttons"], function(a) { return c(a, window, document) }) : "object" === typeof exports ? module.exports = function(a, b) { a || (a = window);
    ...
    c.extend(!0, a.Buttons.defaults, {
        dom: {
            ...
            collection: { tag: "div", className: "dropdown-menu", button: { tag: "a", className: " btn-group flex-wrap dropdown-item", active: "active", disabled: "disabled" } }
        },
    ...
    a.ext.buttons.collection.rightAlignClassName = "dropdown-menu-left";
    return a.Buttons
});